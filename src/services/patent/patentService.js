...
class PatentService {
    ...
    async getPatent(patentUuid, userId) {
        const response = await fetch(
    ...
    async editPatent(patentUuid, userId, patentData) {
        const response = await fetch(
    ...
    async deletePatent(patentUuid, userId) {
        const response = await fetch(
    ...
    async createPatent(userId, patentName) {
        const response = await fetch(
